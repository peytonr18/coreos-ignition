...
type AzureExtensions struct {
	ResourceDiskEnabled  *bool `json:"resourceDiskEnabled,omitempty"`
	SshdDropInEnabled    *bool `json:"sshdDropInEnabled,omitempty"`
	SudoersDropInEnabled *bool `json:"sudoersDropInEnabled,omitempty"`
...
type Extensions struct {
	Azure AzureExtensions `json:"azure,omitempty"`
}
